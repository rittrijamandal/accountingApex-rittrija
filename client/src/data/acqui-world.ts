/**
 * Static AcquiCo Inc. world payload — always available in the Grader Lobby
 * without requiring a Supabase DB row.
 */
export const ACQUI_STATIC_ID = "static-acqui";

export const ACQUI_WORLD_PAYLOAD = {
  meta: {
    id: "APEX-ACQUI-W01",
    company: "AcquiCo Inc.",
    ...
    employees: 254,
    archetype: "Mergers & Acquisitions",
...
NOTE,Row 52 in source census is a second CEO. File also contains duplicate CFO and finance/legal leadership overlap relevant to synergy analysis.`,
  ...
  rubric: [
    ...
    {
      n: 2,
      text: "Correctly reports Adjusted EBITDA as FY2021=$5,500K, FY2022=$5,200K, FY2023=$6,650K.",
      type: "det",
      label: "deterministic",
    },
    {
    ...
    {
      n: 4,
      text: "Identifies the FY2022 $10.0M real estate sale gain as non-recurring income that should be subtracted from normalized EBITDA.",
      type: "llm",
      label: "llm judge",
    },
    {
    ...
    {
      n: 7,
      text: "Personnel synergy answer mentions duplicate CEO role, duplicate CFO or CFO-adjacent roles, and G&A overlap in Finance/Accounting and Legal, with an estimated $2M-$4M synergy range.",
      type: "llm",
      label: "llm judge",
    },
    {
