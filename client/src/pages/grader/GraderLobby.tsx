  ...
  return (
    <AppShell sidebar={false}>
      <div className="px-8 pt-8 pb-2">
        <div className="label-eyebrow">Grader Lobby</div>
        ...
        <p className="text-sm text-slate-500 mt-2">
          {loading
            ? "Loading…"
            : `${worlds.length} published benchmark${worlds.length !== 1 ? "s" : ""}: Audit, Invoice Approval, and Deals & Advisory. Experts use Sample preview from the editor — not this lobby.`}
        </p>
      </div>
        ...
        {loading && worlds.length === 0 ? (
          ...
          <div className="rounded-3xl bg-white shadow-sm p-12 text-center">
            ...
            <p className="text-sm text-slate-400 mt-2">
              ...
              <strong>Deals & Advisory</strong>) so they appear here. Deals &amp; Advisory always falls back to the built-in
              sample if missing.
            </p>
          </div>
        ) : (
